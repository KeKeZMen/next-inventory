...
const tableHeadCells = ["ID", "Название", "Кол-во"];
...
export const ConsumablesTable: FC<PropsType> = ({
  ...
  return (
    ...
    >
      ...
      <table className="overflow-y-auto rounded-md border-collapse grid grid-cols-[minmax(74px,_1fr)_minmax(74px,_1fr)_minmax(149px,_2fr)]">
